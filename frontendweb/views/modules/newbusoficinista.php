...
<div class="divFormulario">
        <form class="formularioLogin" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="cooperativa" id="cooperativa" placeholder="Cooperativa" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="30" class="form-control" value="30"  name="numeroasientos" id="numeroasientos" required>
            </div>
            <div class="mb-3">
                <label for="min_hum" class="form-label" style="font-weight:bold;">Numero de registro </label>
                <input type="text" class="form-control" name="numeroregistro" id="numeroregistro" placeholder="Numero de Registro" required>
            </div>
            <div class="mb-3">
                <label for="max_hum" class="form-label" style="font-weight:bold;">Numero de Chasis</label>
                <input type="text" class="form-control" name="numerochasis" id="numerochasis" placeholder="Numero de Chasis" required>
            </div>
            <div class="mb-3">
